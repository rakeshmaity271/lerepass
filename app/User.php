...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'phone', 'api_token', 'birth_date', 'working', 'lat', 'lng', 'numorders', 'rejectedorders','coupon_code',
    ];
    ...
    {
        return $this->hasOne(\App\Subscription::class, 'id', 'subscription_plan_id');
    }
