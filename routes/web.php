...
//     dd('Hello World');
// });
Route::get('/html/registration', 'FrontEndController@renderRegistrationHtml')->name('html.registration');
Route::get('/', 'FrontEndController@index')->name('front');
Route::get('/'.config('settings.url_route').'/{alias}', 'FrontEndController@show_table');
Route::get('/'.config('settings.url_route').'s/{alias}', 'FrontEndController@restorant')->name('vendor');
Route::post('/restaurant/choose_table', 'FrontEndController@choose_table');
...
Route::group(['middleware' => ['auth', 'isPlanSubscribe']], function () {
...
Route::post('/user/subscribe', 'PaymentController@subscribe');

Route::post('/user/coupon', 'PaymentController@updateCoupon');

Route::post('/user/subscribe/inRegister', 'PaymentController@subscribeInRegister');

Route::get('/remove/card', 'PaymentController@removeCard')->name('user.remove.card');

Route::get('/update/plan/{plan_id}','UserController@updatePlan')->name('user.update.plan');

Route::get('/register/done', 'RestorantController@showFront');
...
Route::get('/social/auth/facebook/redirect', 'SocialAuthFacebookController@redirect')->name('social.auth.facebook.redirect');
Route::get('/social/auth/facebook/callback', 'SocialAuthFacebookController@callback')->name('social.auth.facebook.callback');
