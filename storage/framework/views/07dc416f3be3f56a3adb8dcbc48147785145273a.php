<section class="section-hero-shape" data-offset-top="#header-main" style="padding-top: 147.188px;">
      ...
      <div class="pt--9 position-absolute middle right-0 col-lg-7 col-xl-6 d-none d-lg-block">
        <img style="margin-top: 50px;" src="<?php echo e(asset('social')); ?>/img/wpordering.svg" />
      </div>
                ...
                <div class="alert alert-hero" role="alert">
                  <?php if(auth()->user()&&auth()->user()->hasRole('admin')): ?>
                    <div class="ckedit" key="hot" id="hot">
                      <?php echo e(__('whatsapp.hero_badge_type')); ?>

                    </div>
                    <div class="ckedit" key="hero_badge" id="hero_badge"><?php echo e(__('whatsapp.hero_badge')); ?></div>
                  <?php else: ?>
                      <span class="badge badge-danger badge-pill alert-badge">
                        <?php echo e(__('whatsapp.hero_badge_type')); ?>

                      </span>
                      <span class="alert_content"> <?php echo e(__('whatsapp.hero_badge')); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              <div>
                <h2 class="text-white mb-4">
                  <div class="display-4 font-weight-light ckedit" key="hero_title" id="hero_title"><?php echo e(__('whatsapp.hero_title')); ?></div>
                  <div class="d-block ckedit" key="hero_subtitle" id="hero_subtitle"><?php echo e(__('whatsapp.hero_subtitle')); ?></div>
                </h2>
                <p class="lead text-white ckedit" key="hero_description" id="hero_description"><?php echo e(__('whatsapp.hero_description')); ?></p>
                <div class="mt-5">
                  <?php if(auth()->user()&&auth()->user()->hasRole('admin')): ?>
                  <div class="ckedit btn btn-icon btn-white rounded-pill" key="start_now" id="start_now"><?php echo e(__('whatsapp.start_now')); ?></div>
                  <div class="btn btn-icon rounded-pill btn-outline-white" key="see_demo" id="see_demo"><?php echo e(__('whatsapp.see_demo')); ?></div>
                  <?php else: ?>
                  <button type="button" class="btn btn-icon btn-white rounded-pill" data-toggle="modal" data-target="#modal-register">
                    <span class="btn-inner--text"><?php echo e(__('whatsapp.start_now')); ?></span>
                    <span class="btn-inner--icon"><i class="fas fa-angle-right"></i></span>
                  </button>

                  <a href="/#demo" class="btn btn-icon rounded-pill btn-outline-white" type="button">
                    <span class="btn-inner--icon"><i class="fas fa-angle-right"></i></span>
                    <span class="btn-inner--text"><?php echo e(__('whatsapp.see_demo')); ?></span>
                  </a>
    ...
    </section><?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/social/partials/hero.blade.php ENDPATH**/ ?>