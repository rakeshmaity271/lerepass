    ...
    <div class="card shadow-soft mb-5 mb-lg-6 px-2">
        ...
        <div class="card-footer px-4 pb-4">
            ...
            <a href="<?php echo e(route('newrestaurant.register')); ?>" class="btn btn-block btn-outline-gray animate-up-2">
                <?php echo e(__('qrlanding.pricing_button') . " "); ?> <?php echo e($plan['name']); ?><span class="icon icon-xs ml-3"><i class="fas fa-arrow-right"></i></span>
            </a>
        </div>
    </div>
</div>
<?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/qrsaas/partials/plan.blade.php ENDPATH**/ ?>