            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                ...
                <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
                    ...
                    <div class="mt-32 md:mt-0 relative mx-auto w-full rounded-lg lg:max-w-md">
                        <img class="animate-bounce relative mx-auto" width="490" src="<?php echo e(asset('/vendor/mckenziearts/laravel-notify/images/notifications.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/lerepass.com/public_html/vendor/mckenziearts/laravel-notify/resources/views/notify.blade.php ENDPATH**/ ?>