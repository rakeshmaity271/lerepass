<div id="testimonials" class="section testimonials_section">
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-secondary badge-pill mb-3"><?php echo e(__('whatsapp.testimonials_title')); ?></span><br/>
            <h3 class="display-3 ckedit" key="testimonials_subtitle" id="testimonials_subtitle"><?php echo e(__('whatsapp.testimonials_subtitle') . " ❤️"); ?></h3>
          </div>
        </div>
      </div>
                ...
                <div class="testimonials-item-author">
                  <div class="testimonials-item-author-image-container">
                    <img class="avatar rounded-circle"
                      src='<?php echo e(str_contains($testimonial->image, "social") ? $testimonial->image : "/uploads/restorants/".$testimonial->image."_large.jpg"); ?>'
                      class="testimonials-item-author-image">
                  </div>
                  <div class="testimonials-item-author-info">
                    <div class="testimonials-item-author-info-name"><?php echo e($testimonial->title); ?></div>
                    <div class="testimonials-item-author-info-position"><span class="small"><?php echo e($testimonial->subtitle); ?></span></div>
                  </div>
    ...
    </div><?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/social/partials/testimonials.blade.php ENDPATH**/ ?>