<?php $__env->startSection('step'); ?>
    ...
    <div class="flex justify-end">
        <a href="<?php echo e(route('LaravelInstaller::install.server')); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
            Next step
...
<?php echo $__env->make('installer::install', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/lerepass.com/public_html/vendor/mobidonia/laravel-dashboard-installer/src/Views/steps/welcome.blade.php ENDPATH**/ ?>