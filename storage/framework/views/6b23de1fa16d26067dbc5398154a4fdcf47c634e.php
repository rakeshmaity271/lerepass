...
<div class="row">
    <div class="col-md-6">
        <?php echo $__env->make('partials.input',['type'=>"number", 'name'=>'Trial Days','id'=>"trial_days",'placeholder'=>"Total Trial Days",'required'=>false,'value'=>(isset($plan)?$plan->trial_days:null)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
...
<?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/plans/form.blade.php ENDPATH**/ ?>