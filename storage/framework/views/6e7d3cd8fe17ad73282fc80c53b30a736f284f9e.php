...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/mckenziearts/laravel-notify/css/app.css')); ?>">
    <?php echo notifyCss(); ?>
...
<body class="bg-gray-50 text-gray-500 font-body transition duration-100 ease-in-out h-screen">
            ...
            <div class="flex items-center justify-between py-6 border-b border-gray-200">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <?php echo $__env->make('notify::layout.logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
    ...
    <footer class="mx-auto max-w-screen-xl px-4 sm:px-6 py-5 lg:px-8">
        <div class="flex items-center space-x-2 text-gray-500">
            <p>&copy; <?php echo e(date('Y')); ?> - <a href="https://github.com/mckenziearts/laravel-notify" class="font-medium" target="_blank">Laravel <span class="text-pink-600 font-semibold">Notify</span></a> v2.0</p>
    ...
    <script src="<?php echo e(asset('vendor/mckenziearts/laravel-notify/js/app.js')); ?>"></script>
    <?php echo $__env->make('notify::messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo notifyJs(); ?>

</body>
</html>
<?php /**PATH /home/admin/web/lerepass.com/public_html/vendor/mckenziearts/laravel-notify/resources/views/layout/app.blade.php ENDPATH**/ ?>