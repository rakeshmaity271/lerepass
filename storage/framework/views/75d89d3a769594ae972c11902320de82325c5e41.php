<?php $__env->startSection('step'); ?>
    ...
    <form method="post" action="<?php echo e(route('LaravelInstaller::install.setKeys')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('installer::install', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/lerepass.com/public_html/vendor/mobidonia/laravel-dashboard-installer/src/Views/steps/keys.blade.php ENDPATH**/ ?>