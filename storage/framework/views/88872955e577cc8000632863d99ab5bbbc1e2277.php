<div class="pl-lg-4">
    <form id="restorant-form" method="post" action="<?php echo e(route('admin.restaurants.update', $restorant)); ?>" autocomplete="off" enctype="multipart/form-data">
        ...
        <?php endif; ?>  
        <?php echo $__env->make('partials.fields',['fields'=>[
                ['ftype'=>'bool','name'=>"Enable User Registration",'id'=>"user_register",'value'=>($restorant->user_register == 1 ) ? "true" : "false"],
            ]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('partials.fields',['fields'=>[
            ['ftype'=>'bool','name'=>"Enable Whatsapp Order's Only",'id'=>"whatsapp_only",'value'=>($restorant->whatsapp_only == 1 ) ? "true" : "false"],
        ]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <br/>
        <div class="row">
            <?php
...
<?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/restorants/partials/info.blade.php ENDPATH**/ ?>