<section class="section">
    <div class="container">
        <?php if(\Request::has('expedition')&&strlen(\Request::input('expedition'))>1): ?>
        <br/><br/><br/>
        <div class="col-12">
            <div class="form-group">
                <div class="row">
                    <label class="form-control-label" ><?php echo e(__('Deliveries')); ?>&nbsp;&nbsp;&nbsp;</label>
                        <label class="custom-toggle">
                            <input type="checkbox" id="expedition_toggle" <?php if(\Request::input('expedition') == "pickup"){echo "checked";}?>>
                            <span class="custom-toggle-slider rounded-circle"></span>
                        </label>
                    <label class="form-control-label" >&nbsp;&nbsp;<?php echo e(__('Pickup')); ?></label>
                </div>
            </div>
        </div>
        <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-8 ">
                            <div class="form-group mt--2 mb--2">
                                <input name="q" type="text" value="<?php echo e(request()->get('q')); ?>" placeholder="<?php echo e(__('Search for restaurant, cuisines, and dishes')); ?>" class="success form-control form-control-alternative is-valid">
                                <input name="location" value="<?php echo e(request()->get('location')); ?>" type="hidden" />
                            </div>
                        </div>
...
<?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/layouts/headers/filters.blade.php ENDPATH**/ ?>