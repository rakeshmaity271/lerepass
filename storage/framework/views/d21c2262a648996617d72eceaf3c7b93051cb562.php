                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('password.update')); ?>">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4"><?php echo e(__('Reset Password')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>