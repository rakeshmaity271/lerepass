                ...
                <div class="testimonials-item-author">
                  <div class="testimonials-item-author-image-container">
                    <img class="avatar rounded-circle"
                      src='<?php echo e(str_contains($item->image, "social") ? $item->image : "/uploads/restorants/".$item->image."_large.jpg"); ?>'
...
<?php echo $__env->make('general.index', $setup, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/landing/testimonials/index.blade.php ENDPATH**/ ?>