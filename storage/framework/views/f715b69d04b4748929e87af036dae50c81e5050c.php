          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            <?php if(isset($restorant)): ?>
                ...
                <?php if(config('app.isqrsaas')): ?>
                  ...
                  <?php if(!$restorant->getConfig('disable_callwaiter', 0) && strlen(config('broadcasting.connections.pusher.app_id')) > 2 && strlen(config('broadcasting.connections.pusher.key')) > 2 && strlen(config('broadcasting.connections.pusher.secret')) > 2): ?>
...
<?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/layouts/menu/top_justlogo.blade.php ENDPATH**/ ?>