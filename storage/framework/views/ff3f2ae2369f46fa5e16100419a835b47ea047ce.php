        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0"><?php echo e(__('AuthO is the new Authentication Mechanizm')); ?></h3>
                    </div>
            ...
            <div class="card-body">
                ...
                <?php if(strlen(config('settings.auth0_token'))>5&&strlen(config('settings.auth_connection'))>4): ?>
                    ...
                    <div class="text-center">
                        <a  href="<?php echo e(route('admin.syncV1UsersToAuth0')); ?>" class="btn btn-danger mt-4"><?php echo e(__("Sync Existing Users to AuthO (So they need to do Password Reset)")); ?></a>
                    </div>
                <?php else: ?>
                    <p>In v2 we have migrated to Auth0. So, we need to sync users and their passwords to Auth0 Database.
                ...
                <?php endif; ?> 
                <div class="text-center">
                    <a  href="<?php echo e(route('admin.dontsyncV1UsersToAuth0')); ?>" class="btn btn-white mt-4"><?php echo e(__("Do not Sync Existing Users to AuthO (So they need to do Sign Up)")); ?></a>
                </div>
...
<br /><?php /**PATH /home/admin/web/lerepass.com/public_html/resources/views/settings/synctoauth0.blade.php ENDPATH**/ ?>